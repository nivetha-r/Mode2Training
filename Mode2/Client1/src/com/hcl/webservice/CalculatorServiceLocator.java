...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.hcl.webservice.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.24:8282/WebServiceDemo/services/Calculator";
    ...
    public com.hcl.webservice.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.webservice.CalculatorSoapBindingStub _stub = new com.hcl.webservice.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.webservice.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.webservice.CalculatorSoapBindingStub _stub = new com.hcl.webservice.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.hcl.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.hcl.com", "Calculator"));
        }
